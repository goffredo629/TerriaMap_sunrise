      ...
      <Box column styledMinHeight={"0"} flex={1}>
        ...
        >
          ...
          <Box justifySpaceBetween>
            <SidePanelButton  // gd explore map data button
            ...
            {/* <SidePanelButton // gd upload data button temporarily removed until we have a better solution for file uploads on mobile
