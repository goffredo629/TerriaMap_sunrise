...
const DragDropFile = observer(() => {
    ...
    const handleDrop = async (e) => {
        ...
        for (let i = 0; i < e.dataTransfer.files.length; i++) {
            ...
            viewState.terria.analytics?.logEvent(Category.dataSource, DataSourceAction.addFromDragAndDrop, `File Type: ${fileType}, File Size(B): ${e.dataTransfer.files[i].size}`);
        }
        try {
