...
const Notification = observer(() => {
    ...
    return notification.showAsToast ? (_jsx(NotificationToast, { notification: notification })) : (_jsx(NotificationWindow, { viewState: viewState, title: notification.title, message: notification.message, confirmText: notification.confirmText, denyText: notification.denyText, onConfirm: confirm, onDeny: deny, type: notification.type ?? "notification", width: notification.width, height: notification.height }));
});
