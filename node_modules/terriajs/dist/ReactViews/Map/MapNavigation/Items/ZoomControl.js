...
class ZoomControlBase extends Component {
    ...
    render() {
        ...
        return (_jsx(StyledZoomControl, { children: _jsxs(Ul, { column: true, css: `
            padding: 0;
          `, children: [_jsx(Li, { children: _jsx(RawButton, { type: "button", onClick: this.zoomIn.bind(this), title: t("zoomControl.zoomIn"), children: _jsx(Icon, { glyph: Icon.GLYPHS.zoomIn }) }) }), _jsx(Li, { children: _jsx(RawButton, { type: "button", onClick: this.zoomReset.bind(this), title: t("zoomControl.zoomReset"), children: _jsx(Icon, { glyph: Icon.GLYPHS.zoomReset }) }) }), _jsx(Li, { children: _jsx(RawButton, { type: "button", onClick: this.zoomOut.bind(this), title: t("zoomControl.zoomOut"), children: _jsx(Icon, { glyph: GLYPHS.zoomOut }) }) })] }) }));
    }
}
