...
const DropdownPanel = createReactClass({
    ...
    onInnerMounted(innerElement) {
        ...
        if (centerInnerDropdown) {
            ...
            const buttonElementOffsetLeft = btnRef?.current?.offsetLeft || this.buttonElement?.offsetLeft || 0;
            const buttonElementClientWidth = btnRef?.current?.clientWidth || this.buttonElement?.clientWidth || 0;
