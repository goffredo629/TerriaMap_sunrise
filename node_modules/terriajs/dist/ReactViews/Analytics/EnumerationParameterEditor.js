...
let EnumerationParameterEditor = class EnumerationParameterEditor extends Component {
    ...
    render() {
        ...
        return (_jsxs("select", { className: Styles.field, onChange: this.onChange.bind(this), value: value, children: [(!isDefined(value) || !this.props.parameter.isRequired) && (_jsx("option", { value: "", children: "Not specified" }, "__undefined__")), isDefined(value) &&
                    !this.props.parameter.options.find((option) => option.id === value) && (_jsxs("option", { value: value, children: ["Invalid value (", value, ")"] }, "__invalid__")), this.props.parameter.options.map((v, i) => (_jsx("option", { value: v.id, children: v.name ?? v.id }, i)))] }));
    }
};
__decorate([
    action
