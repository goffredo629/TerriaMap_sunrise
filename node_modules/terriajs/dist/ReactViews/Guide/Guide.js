...
export const analyticsSetShowGuide = (isOpen, index, guideKey, terria, options = {
    ...
    const action = options.setCalledFromInside
        ...
        : isOpen
            ? GuideAction.open
            : GuideAction.close;
    terria.analytics?.logEvent(Category.guide, action, `At index: ${index}, Guide: ${guideKey}`);
};
export const GuidePure = ({ terria, guideKey, hasIntroSlide = false, guideData, setShowGuide }) => {
    ...
    const handlePrev = () => {
        ...
        terria.analytics?.logEvent(Category.guide, GuideAction.navigatePrev, `New index: ${newIndex}, Guide: ${guideKey}`);
    ...
    const handleNext = () => {
        ...
        if (guideData[newIndex]) {
            terria.analytics?.logEvent(Category.guide, GuideAction.navigateNext, `New index: ${newIndex}, Guide: ${guideKey}`);
            setCurrentGuideIndex(newIndex);
        }
        else {
            handleSetShowGuide(false);
