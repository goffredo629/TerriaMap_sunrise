...
let DataPreview = class DataPreview extends Component {
    ...
    renderUnloadedReference() {
        ...
        return (_jsx("div", { className: Styles.preview, children: _jsxs("div", { className: Styles.previewInner, children: [isLoading && _jsx(Loader, {}), !isLoading && !hasTarget && (_jsxs(_Fragment, { children: [_jsxs("div", { className: Styles.placeholder, children: [_jsx("h2", { children: "Unable to resolve reference" }), !this.props.previewed.loadReferenceResult?.error ? (_jsx("p", { children: "This reference could not be resolved because it is invalid or because it points to something that cannot be visualised." })) : null] }), this.props.previewed.loadReferenceResult?.error ? (_jsx(WarningBox, { error: this.props.previewed.loadReferenceResult?.error, viewState: this.props.viewState })) : null] }))] }) }));
    }
};
