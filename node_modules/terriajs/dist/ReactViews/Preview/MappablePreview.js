...
let MappablePreview = class MappablePreview extends Component {
    ...
    render() {
        ...
        return (_jsxs("div", { className: Styles.root, children: [MappableMixin.isMixedInto(catalogItem) &&
                    !catalogItem.disablePreview && (_jsx(DataPreviewMap, { terria: this.props.terria, previewed: catalogItem, showMap: true })), _jsx("button", { type: "button", onClick: this.toggleOnMap.bind(this), className: Styles.btnAdd, children: this.props.terria.workbench.contains(catalogItem)
                        ...
                        : t("preview.addToMap") }), _jsxs("div", { className: Styles.previewedInfo, children: [_jsxs("div", { className: Styles.titleAndShareWrapper, ref: (component) => (this.refToMeasure = component), children: [_jsx("h3", { className: Styles.h3, children: catalogItem.name }), !catalogItem.hasLocalData &&
                                    !this.props.viewState.useSmallScreenInterface && (_jsx("div", { className: Styles.shareLinkWrapper, children: _jsx(SharePanel, { catalogShare: true, catalogShareWithoutText: true, modalWidth: this.props.widthFromMeasureElementHOC, terria: this.props.terria, viewState: this.props.viewState }) }))] }), catalogItem.loadMetadataResult?.error && (_jsx(WarningBox, { error: catalogItem.loadMetadataResult?.error, viewState: this.props.viewState })), catalogItem.loadMapItemsResult?.error && (_jsx(WarningBox, { error: catalogItem.loadMapItemsResult?.error, viewState: this.props.viewState })), _jsx(Description, { item: catalogItem })] })] }));
    }
};
