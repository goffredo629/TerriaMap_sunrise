...
let GroupPreview = class GroupPreview extends Component {
    ...
    render() {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { className: Styles.titleAndShareWrapper, ref: (component) => (this.refToMeasure = component), children: [_jsx("h3", { children: this.props.previewed.name }), _jsxs("div", { className: Styles.shareLinkWrapper, children: [this.props.previewed.displayGroup === true && (_jsx("button", { type: "button", onClick: (event) => {
                                        ...
                                        : t("models.catalog.addAll") })), _jsx(SharePanel, { catalogShare: true, modalWidth: this.props.widthFromMeasureElementHOC, terria: this.props.terria, viewState: this.props.viewState })] })] }), this.props.previewed.loadMetadataResult?.error && (_jsx(WarningBox, { error: this.props.previewed.loadMetadataResult?.error, viewState: this.props.viewState })), this.props.previewed.loadMembersResult?.error && (_jsx(WarningBox, { error: this.props.previewed.loadMembersResult?.error, viewState: this.props.viewState })), _jsx("div", { className: Styles.previewedInfo, children: _jsxs("div", { className: Styles.url, children: [this.props.previewed.description &&
