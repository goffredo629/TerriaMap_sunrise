...
let Breadcrumbs = class Breadcrumbs extends Component {
    ...
    renderCrumb(parent, i, parentGroups) {
        ...
        if (i === parentGroups.length - 1) {
            ...
            return (_jsx(RawButtonAndUnderline, { type: "button", onClick: () => this.openInCatalog(ancestors.slice(i, i + 1)), children: _jsx(TextSpan, { small: true, textDark: true, isLink: true, children: parent }) }));
    ...
    render() {
        ...
        _jsxs(Box, { left: true, styledMinHeight: "32px", fullWidth: true, backgroundColor: this.props.theme.greyLighter, paddedHorizontally: 2.4, paddedVertically: 1, wordBreak: "break-all", children: [_jsx(StyledIcon, { styledWidth: "16px", fillColor: this.props.theme.textDark, glyph: Icon.GLYPHS.globe }), _jsx(Spacing, { right: 1.2 }), _jsx(Box, { flexWrap: true, alignItemsFlexEnd: true, children: parentGroups &&
