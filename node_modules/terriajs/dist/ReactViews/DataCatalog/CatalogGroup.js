...
const CatalogGroup = observer((props) => {
    ...
    return (_jsxs("li", { className: Styles.root, children: [_jsxs(Text, { fullWidth: true, primary: !props.selected && props.isPrivate, children: [props.displayGroup === true && (_jsx(Box, { children: _jsx("button", { type: "button", 
                ...
                }), children: [props.loading && (_jsx("li", { children: _jsx(Loader, {}) }, "loader")), !props.loading &&
                        props.children.length === 0 &&
                        props.emptyMessage && (_jsx("li", { className: classNames(Styles.label, Styles.labelNoResults), children: props.emptyMessage }, "empty")), !props.loading ? props.children : null] }))] }));
});
