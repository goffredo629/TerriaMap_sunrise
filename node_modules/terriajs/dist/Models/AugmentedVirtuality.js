...
export default class AugmentedVirtuality {
    ...
    maximumUpdatesPerSecond = AugmentedVirtuality.DEFAULT_MAXIMUM_UPDATES_PER_SECOND;
    ...
    hoverLevel = AugmentedVirtuality.PRESET_HEIGHTS.length - 1;
    constructor(terria) {
        this.terria = terria;
        makeObservable(this);
    }
     ...
     */
    boundStoreOrientation = this.storeOrientation.bind(this);
    /**
