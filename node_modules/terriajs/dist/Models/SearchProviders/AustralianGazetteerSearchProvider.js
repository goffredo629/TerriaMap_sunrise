...
export default class AustralianGazetteerSearchProvider extends WebFeatureServiceSearchProviderMixin(CreateModel(WebFeatureServiceSearchProviderTraits)) {
    static type = "australian-gazetteer-search-provider";
    constructor(...args) {
        super(...args);
        makeObservable(this);
    }
    ...
    logEvent(searchText) {
        this.terria.analytics?.logEvent(Category.search, SearchAction.gazetteer, searchText);
    }
    featureToSearchResultFunction = featureToSearchResultFunction;
