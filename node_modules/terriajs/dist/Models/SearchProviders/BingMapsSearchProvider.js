...
export default class BingMapsSearchProvider extends LocationSearchProviderMixin(CreateModel(BingMapsSearchProviderTraits)) {
    static type = "bing-maps-search-provider";
    get type() {
    ...
    logEvent(searchText) {
        this.terria.analytics?.logEvent(Category.search, SearchAction.bing, searchText);
    }
