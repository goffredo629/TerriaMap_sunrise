...
export default class CesiumIonSearchProvider extends LocationSearchProviderMixin(CreateModel(CesiumIonSearchProviderTraits)) {
    static type = "cesium-ion-search-provider";
    get type() {
    ...
    logEvent(searchText) {
        this.terria.analytics?.logEvent(Category.search, SearchAction.cesium, searchText);
    }
