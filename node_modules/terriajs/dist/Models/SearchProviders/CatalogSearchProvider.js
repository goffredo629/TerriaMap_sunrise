...
export default class CatalogSearchProvider extends CatalogSearchProviderMixin(CreateModel(CatalogSearchProviderTraits)) {
    static type = "catalog-search-provider";
    isSearching = false;
    debounceDurationOnceLoaded = 300;
    ...
    logEvent(searchText) {
        this.terria.analytics?.logEvent(Category.search, SearchAction.catalog, searchText);
    }
