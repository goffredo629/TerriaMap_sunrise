...
export default class TableStylingWorkflow {
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.color.legend.setTrait(stratumId, "title", value);
                        }
                    },
                    this.colorSchemeType === "diverging-continuous" ||
                        this.colorSchemeType === "sequential-continuous"
                        ? {
                            ...
                            setDimensionValue: (stratumId, value) => {
                                this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "legendTicks", value);
                            }
                        }
                        : undefined,
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.setTrait(stratumId, "title", value);
                        }
                    },
                    {
                        type: "select",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.setTrait(stratumId, "longitudeColumn", value);
                        }
                    },
                    {
                        type: "select",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.setTrait(stratumId, "latitudeColumn", value);
                        }
                    }
                ])
            },
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "timeColumn", value);
                        }
                    },
                    {
                        type: "select",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "endTimeColumn", value);
                        }
                    },
                    {
                        type: "select-multi",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "idColumns", value);
                        }
                    },
                    {
                        type: "checkbox",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "isSampled", value === "true");
                        }
                    },
                    {
                        type: "numeric",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "displayDuration", value);
                        }
                    },
                    {
                        type: "checkbox",
                        ...
                        selectedId: this.tableStyle.timeTraits.spreadStartTime
                            ...
                            : "false",
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "spreadStartTime", value === "true");
                        }
                    },
                    {
                        type: "checkbox",
                        ...
                        selectedId: this.tableStyle.timeTraits.spreadFinishTime
                            ...
                            : "false",
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.time.setTrait(stratumId, "spreadFinishTime", value === "true");
                        }
                    }
                ])
            },
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableStyleTraits(stratumId)?.setTrait(stratumId, "hidden", value === "false");
                        }
                    },
                    {
                        type: "checkbox",
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableColumnTraits(stratumId)?.setTrait(stratumId, "title", value);
                        }
                    },
                    {
                        type: "text",
                        ...
                        setDimensionValue: (stratumId, value) => {
                            this.getTableColumnTraits(stratumId)?.setTrait(stratumId, "units", value);
                        }
                    }
                ])
            }
                    ...
                    selectableDimensions: filterOutUndefined([
                        ...
                        ...traits.enum?.map((enumPoint, idx) => {
                            const dims = {
                                type: "group",
                                id: `${key}-enum-${idx}`,
                                name: getPreview(tableStyleMap.traitValues.enum[idx], tableStyleMap.traitValues.null, tableStyleMap.commonTraits.enum[idx].value ??
                                    i18next.t("models.tableStyling.style.selectableDimensions.enum.selectableDimensions.enum.noValue")),
                                ...
                                selectableDimensions: [
                                    {
                                        ...
                                        options: filterOutUndefined([
                                            ...
                                            ...(tableStyleMap.column?.uniqueValues.values
                                                ?.filter((value) => !traits.enum.find((enumCol) => enumCol.value === value))
                                                .map((id) => ({ id })) ?? [])
                                        ]),
                                        setDimensionValue: (stratumId, value) => {
                        ...
                        // Are there more colors to add (are there more unique values in the column than enumCols)
                        // Create "Add" to user can add more
                        tableStyleMap.column?.uniqueValues.values.filter((v) => !traits.enum?.find((col) => col.value === v)).length > 0
                            ? {
                                type: "button",
                                id: `${key}-enum-add`,
                                value: i18next.t("models.tableStyling.style.selectableDimensions.enum.selectableDimensions.enum.add.value"),
                                setDimensionValue: (stratumId) => {
                                    const firstValue = tableStyleMap.column?.uniqueValues.values.find((value) => !traits.enum?.find((col) => col.value === value));
                                    if (!isDefined(firstValue))
                                        return;
                    ...
                    selectableDimensions: filterOutUndefined([
                        ...
                        ...traits.bin
                            ...
                            const dims = {
                                type: "group",
                                id: `${key}-bin-${idx}`,
                                name: getPreview(tableStyleMap.traitValues.bin[idx], tableStyleMap.traitValues.null, !isDefined(bin.maxValue ?? undefined)
    ...
    get markerDims() {
        return this.getStyleDims(i18next.t("models.tableStyling.point.name"), "point", this.tableStyle.pointStyleMap, (id, pointTraits, nullValues) => filterOutUndefined([
            ...
            !this.tableStyle.pointSizeColumn
                ...
                : undefined
        ]), (point, nullValue, label) => `<div><img height="${24}px" style="margin-bottom: -4px; transform: rotate(${point.rotation ?? 0}deg)" src="${getMakiIcon(point.marker ?? nullValue.marker, "#fff", 1, "#000", 24, 24) ?? point.marker}"></img> ${label}</div>`);
    }
    get outlineDims() {
        ...
        ], (outline, nullValue, label) => getColorPreview(outline.color ?? nullValue.color ?? "#aaa", label));
    }
    get labelDims() {
        return this.getStyleDims(i18next.t("models.tableStyling.label.name"), "label", this.tableStyle.labelStyleMap, (id, labelTraits, nullValues) => filterOutUndefined([
            {
                type: "select",
                id: `${id}-column`,
                ...
                : undefined,
            {
                ...
                selectedId: labelTraits.horizontalOrigin ?? nullValues.horizontalOrigin,
                options: [
                    {
                        id: "LEFT",
    ...
    get trailDims() {
        return [
            ...this.getStyleDims("Trail style", "trail", this.tableStyle.trailStyleMap, (id, trailTraits, nullValues) => filterOutUndefined([
                {
                    type: "numeric",
                    id: `${id}-lead-time`,
                    ...
                    ? [
                        {
                            ...
                            value: trailTraits.polylineGlow.color ??
                        ...
                        },
                        {
                            ...
                            value: trailTraits.polylineGlow.glowPower ??
                        ...
                        },
                        {
                            ...
                            value: trailTraits.polylineGlow.taperPower ??
                    ...
                    : [
                        {
                            ...
                            value: trailTraits.solidColor.color ??
                ...
                selectableDimensions: filterOutUndefined([
                    {
                        ...
                        setDimensionValue: (stratumId, value) => {
                            if (value === "solidColor" || value === "polylineGlow")
                                this.getTableStyleTraits(stratumId)?.trail.setTrait(stratumId, "materialType", value);
                        }
                    }
                ])
            }
    ...
    setBinMaximums(stratumId, binMaximums) {
        ...
        if (binMaximums[binMaximums.length - 1] !==
            ...
            colorTraits?.setTrait(stratumId, "maximumValue", binMaximums[binMaximums.length - 1]);
        }
    ...
    resetBinMaximums(stratumId) {
        this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "minimumValue", undefined);
        this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "maximumValue", undefined);
        this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "binMaximums", undefined);
        const binMaximums = this.tableStyle.tableColorMap.binMaximums.map((bin) => parseFloat(bin.toFixed(this.tableStyle.numberFormatOptions?.maximumFractionDigits)));
        this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "binMaximums", binMaximums);
    }
    ...
    setEnumColorTrait(stratumId, index, value, color) {
        ...
        this.getTableStyleTraits(stratumId)?.color.setTrait(stratumId, "enumColors", enumColors);
    }
    ...
    getTableStyleTraits(stratumId, id = this.tableStyle.id) {
        ...
        const style = this.item.styles?.find((style) => style.id === id) ??
    ...
    getTableColumnTraits(stratumId) {
        if (!this.tableStyle.colorColumn?.name)
            return;
        return (this.item.columns?.find((col) => col.name === this.tableStyle.colorColumn.name) ??
            this.item.addObject(stratumId, "columns", this.tableStyle.colorColumn.name));
    }
}
__decorate([
    observable
