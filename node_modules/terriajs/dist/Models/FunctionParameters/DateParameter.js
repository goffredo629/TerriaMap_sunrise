...
export default class DateParameter extends FunctionParameter {
     ...
     */
    get value() {
        return (super.value ?? (this.isRequired ? this.currentClockDate() : undefined));
    }
    /**
     * Validate and set datetime value
     */
    setValue(stratumId, newValue) {
        super.setValue(stratumId, this.isValidDate(newValue) ? newValue : undefined);
    }
    isValidDate(value) {
...
__decorate([
    override
], DateParameter.prototype, "value", null);
