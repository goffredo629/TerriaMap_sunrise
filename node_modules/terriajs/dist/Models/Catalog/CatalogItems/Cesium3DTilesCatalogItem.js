...
export default class Cesium3DTilesCatalogItem extends SearchableItemMixin(FeatureInfoUrlTemplateMixin(Cesium3dTilesMixin(CreateModel(Cesium3DTilesCatalogItemTraits)))) {
    static type = "3d-tiles";
    type = Cesium3DTilesCatalogItem.type;
    constructor(...args) {
        super(...args);
        makeObservable(this);
    }
     ...
     */
    zoomToItemSearchResult = action(async (result) => {
