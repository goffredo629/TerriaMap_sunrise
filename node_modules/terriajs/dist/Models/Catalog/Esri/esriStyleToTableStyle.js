...
export function esriStyleToTableStyle(esriStyle, label) {
    ...
    return {
        ...
        point: createStratumInstance(PointSymbolTraits, {
            ...
            height: convertEsriPointSizeToPixels(esriStyle.size) ??
                convertEsriPointSizeToPixels(esriStyle.height),
            width: convertEsriPointSizeToPixels(esriStyle.size) ??
        ...
        outline: esriStyle.outline?.style !== "esriSLSNull"
            ? createStratumInstance(OutlineSymbolTraits, {
                color: esriStyle.type === "esriSLS"
                    ? convertEsriColorToCesiumColor(esriStyle.color)?.toCssColorString()
                    : convertEsriColorToCesiumColor(esriStyle.outline?.color)?.toCssColorString(),
