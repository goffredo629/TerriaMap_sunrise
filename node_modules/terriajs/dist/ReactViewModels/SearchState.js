...
export default class SearchState {
    catalogSearchText = "";
    isWaitingToStartCatalogSearch = false;
    locationSearchText = "";
    isWaitingToStartLocationSearch = false;
    unifiedSearchText = "";
    isWaitingToStartUnifiedSearch = false;
    showLocationSearchResults = false;
    showMobileLocationSearch = false;
    showMobileCatalogSearch = false;
    locationSearchResults = [];
    catalogSearchResults;
    unifiedSearchResults = [];
    _catalogSearchDisposer;
    _locationSearchDisposer;
    _unifiedSearchDisposer;
    _workbenchItemsSubscription;
    terria;
    constructor(options) {
        makeObservable(this);
    ...
    get supportsAutocomplete() {
        return this.locationSearchProviders.every((provider) => provider.supportsAutocomplete());
    }
...
__decorate([
    computed
], SearchState.prototype, "supportsAutocomplete", null);
__decorate([
    computed
