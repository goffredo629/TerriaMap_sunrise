...
export default class TableColorMap {
    ...
    get colorMap() {
        ...
        return new ConstantColorMap({
            ...
            nullColor: colorColumn?.type === TableColumnType.region
                ? this.nullColor
                : undefined
        });
    }
     ...
     */
    get regionValues() {
        const regionColumn = this.colorColumn?.tableModel.activeTableStyle.regionColumn;
    ...
    invalidColorPaletteWarning() {
        if (this.colorColumn?.name &&
            this.colorColumn?.tableModel.activeStyle === this.colorColumn?.name) {
            runLater(() => this.colorColumn?.tableModel.terria.raiseErrorToUser(new TerriaError({
