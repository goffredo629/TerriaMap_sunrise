...
function FeatureInfoUrlTemplateMixin(Base) {
    class FeatureInfoUrlTemplateMixin extends Base {
                ...
                (async () => {
                    if (loadExternal && isDefined(this.featureInfoUrlTemplate)) {
                        ...
                        try {
                            ...
                            feature.description = new ConstantProperty(generateCesiumInfoHTMLFromProperties(feature.properties, (TimeVarying.is(this)
                                ? this.currentTimeAsJulianDate
                                : undefined) ?? JulianDate.now(), MappableMixin.isMixedInto(this)
        ...
        wrapImageryPickFeatures(imageryProvider) {
            ...
            const proxiedFeatureInfoUrl = proxyCatalogItemUrl(this, featureInfoUrlTemplate ?? "", "0d");
                ...
                if (isDefined(featureInfoUrlTemplate) &&
                    ...
                    for (let i = 0; i < features.length; i++) {
                        ...
                        try {
                            ...
                            // Update description of the feature after it is resolved from
                            // feature info template url
                            feature.description = generateCesiumInfoHTMLFromProperties(feature.properties, currentTime ?? JulianDate.now(), showStringIfPropertyValueIsNull);
                        }
                        catch (_e) {
                            if (!feature.properties) {
                                feature.properties = {};
