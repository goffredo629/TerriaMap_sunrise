...
function TimeFilterMixin(Base) {
    class TimeFilterMixin extends DiscretelyTimeVaryingMixin(Base) {
        ...
        get featureTimesAsJulianDates() {
            ...
            const featureTimes = this._currentTimeFilterFeature.properties[this.timeFilterPropertyName]?.getValue(this.currentTime);
        ...
        get discreteTimesAsSortedJulianDates() {
            ...
            return super.discreteTimesAsSortedJulianDates?.filter((dt) => featureTimes.some((d) => d.equals(dt.time)));
        }
...
async function pickImageryProviders(imageryProviders, pickCoordinates, pickPosition) {
    return filterOutUndefined(await Promise.all(imageryProviders.map((imageryProvider) => imageryProvider
        .pickFeatures(pickCoordinates.x, pickCoordinates.y, pickCoordinates.level, pickPosition.longitude, pickPosition.latitude)
