...
import { action, computed, makeObservable, observable, toJS, untracked } from "mobx";
...
function ClippingMixin(Base) {
    class ClippingMixinBase extends Base {
        ...
        get simpleClippingPlaneCollection() {
            ...
            const clippingPlaneCollection = this.getOrCreateClippingPlanesCollection();
        ...
        getOrCreateClippingPlanesCollection() {
        ...
        get clippingPlaneCollection() {
            return (this.simpleClippingPlaneCollection ?? this.clippingBoxPlaneCollection);
        }
        get clippingMapItems() {
            return filterOutUndefined([this.clippingBoxDrawing?.dataSource]);
        }
        get clippingBoxDimensions() {
            const dimensions = new Cartesian3(this.clippingBox.dimensions.length ?? 100, this.clippingBox.dimensions.width ?? 100, this.clippingBox.dimensions.height ?? 100);
            return dimensions;
        }
        get clippingBoxHpr() {
    ...
    __decorate([
        observable
    ], ClippingMixinBase.prototype, "_clippingPlaneCollection", void 0);
    __decorate([
        computed
    ...
    __decorate([
        computed
    ], ClippingMixinBase.prototype, "clippingDimensions", null);
    __decorate([
        computed
