...
let WebMapServiceCatalogGroupTraits = class WebMapServiceCatalogGroupTraits extends mixTraits(GetCapabilitiesTraits, GroupTraits, UrlTraits, CatalogMemberTraits, LegendOwnerTraits) {
    flatten;
    perLayerLinkedWcs;
};
__decorate([
...
WebMapServiceCatalogGroupTraits = __decorate([
    traitClass({
...
export default WebMapServiceCatalogGroupTraits;
