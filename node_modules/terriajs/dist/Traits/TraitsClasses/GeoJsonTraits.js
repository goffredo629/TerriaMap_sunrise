...
__decorate([
    primitiveTrait({
        ...
        description: "If true, point features will render without depth testing so they remain visible through terrain and tiles."
    })
], GeoJsonTraits.prototype, "disableDepthTest", void 0);
__decorate([
    objectTrait({
        type: ClusteringTraits,
        name: "clustering",
        description: "Allows to activate the clustering of entities, works only with Cesium as a viewer."
    })
], GeoJsonTraits.prototype, "clustering", void 0);
