...
let TerriaReferenceTraits = class TerriaReferenceTraits extends mixTraits(UrlTraits, CatalogMemberReferenceTraits) {
    isOpen;
    path;
};
__decorate([
...
TerriaReferenceTraits = __decorate([
    traitClass({
...
export default TerriaReferenceTraits;
