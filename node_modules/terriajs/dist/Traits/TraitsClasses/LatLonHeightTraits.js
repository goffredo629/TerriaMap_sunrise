...
export default class LatLonHeightTraits extends ModelTraits {
    ...
    static toCartographic(model, result) {
        ...
        return Cartographic.fromDegrees(longitude, latitude, height, result ?? new Cartographic());
    }
    static toCartesian(model, result) {
        ...
        return Cartesian3.fromDegrees(longitude, latitude, height, undefined, result ?? new Cartesian3());
    }
}
__decorate([
    primitiveTrait({
