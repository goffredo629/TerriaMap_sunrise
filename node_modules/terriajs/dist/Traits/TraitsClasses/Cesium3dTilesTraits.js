...
__decorate([
    primitiveTrait({
        ...
        description: "When true, Cesium does not wait for the draped imagery layers to load before the tileset mesh is rendered. This means while the imagery is being loaded the original tile texture will be shown."
    })
], OptionsTraits.prototype, "asynchronouslyLoadImagery", void 0);
export default class Cesium3DTilesTraits extends mixTraits(HighlightColorTraits, PlaceEditorTraits, TransformationTraits, FeaturePickingTraits, MappableTraits, UrlTraits, CatalogMemberTraits, ShadowTraits, OpacityTraits, LegendOwnerTraits, ShadowTraits, ClippingPlanesTraits, SplitterTraits, LayerOrderingTraits, CesiumIonTraits) {
    options;
    style;
    filters;
    colorBlendMode = "MIX";
...
__decorate([
    primitiveTrait({
        name: "Drape imagery",
        type: "boolean",
        description: "When true allows draping imagery on top of this tileset. Imagery items appearing above this catalog item in the workbench will be draped on top of the tileset."
    })
], Cesium3DTilesTraits.prototype, "drapeImagery", void 0);
