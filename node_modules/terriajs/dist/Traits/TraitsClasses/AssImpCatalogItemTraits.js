...
let AssImpCatalogItemTraits = class AssImpCatalogItemTraits extends mixTraits(GltfCatalogItemTraits) {
    urls = [];
    baseUrl;
};
__decorate([
...
AssImpCatalogItemTraits = __decorate([
    traitClass({
...
], AssImpCatalogItemTraits);
export default AssImpCatalogItemTraits;
